...
import static com.company.methods.books.writingBooks.addBook;
...
import static com.company.methods.books.searchingBooks.searchDecision;

public class Main {

    public static File bookList = new File("bookList.txt");
